...
// Re-export pure functions from core (no external deps, testable directly)
export { createMultiChainFunction } from "./multi-chain-core";
 ...
 */
export const createMultiChainAsyncFunction = async <T, C extends { chainId: string }>(
  chains: C[],
  fn: (chain: C) => Promise<T>,
  caller?: string,
